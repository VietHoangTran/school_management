...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Map<String, dynamic>> listItem = [
    {"icon": "assets/icons/ic_classroom.svg", "name": "Danh sách lớp học", "click": (){}},
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  height: AppValue.heights*0.177,width: AppValue.heights*0.177,
                  decoration: BoxDecoration(
                    color: AppColors.white,
                    borderRadius: BorderRadius.circular( AppValue.heights*0.177),
                    border: Border.all(width: 5, color: const Color(0xFF28C2A0)),
                  ),
                  child: Image.asset('assets/images/image_home.png', fit: BoxFit.contain,),
                ),
              )
            ],
          ),
